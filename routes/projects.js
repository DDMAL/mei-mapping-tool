...
//Arrays for the neumes, the users and the images
...
//this will be accessible from http://localhost:3000/projects if the default route for / is left unchanged
router.route('/')
    //GET all projects
...
/* GET New neume page from a certain project. */
router.get('/:id/new', function(req, res) {
     res.render('projects/newNeume', { title: 'Add New project'});
});

// route middleware to validate :id for the project
